...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Fedor}{Paretsky}{me@f3d0r.com | (206) 372-8476 | Seattle, WA | f3d0r.com}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     Education
%
...
\end{tightemize}
\sectionsep
\runsubsection{srnd.org (StudentRND)}\descript{| Code Evangelist®}\hfill \location{srnd.org - U.S.A. | May 2016 – Present}
\begin{tightemize}
...
\runsubsection{\large{PrivaC}}
\descript{| HTML/CSS/JS, node.js, Google Cloud Natural Language}\hfill \location{http://bit.ly/privacextension}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Awards}
\runsubsection{\large{Garfield HS Certificate of Excellence in Business Technology and CS}} \descript{Garfield HS Career and Technology Education Department | June 2016} \\

\sectionsep
\runsubsection{\large{WA State Honors Award}} \descript{Randy Dorn - State Superintendent of Public Instruction | June 2016} \\

\sectionsep
\runsubsection{\large{Outstanding Soloist - Honorable Mention}} \descript{Wynton Marsalis | May 2016} \\
Awarded at the 2016 International Essentially Ellington Jazz Band Competition.\\
\sectionsep
\runsubsection{\large{Outstanding Soloist}} \descript{Wynton Marsalis | May 2015} \\
